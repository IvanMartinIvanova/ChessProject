...
Cara::Cara(Vector3D in1, Vector3D in2, Color col = { 238,130,238 }) :
	esq1{ in1 },
	esq2{ in2 },
	color {col}
{
...
Cara::Cara(float in1x, float in1y, float in1z, float in2x, float in2y, float in2z, Color col = { 238,130,238 }):
	esq1 {in1x,in1y,in1z},
	esq2 {in2x,in2y,in2z},
	color{ col }
{
